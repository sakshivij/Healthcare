        ...
        <div class="row">
          <div class="col-lg-7 col-md-7 col-sm-6">
            <div class="contact-form">
              ...
              <p>Fill out all required Field to request for blood to users within 50km</p>
        <form method="post" action="mailJSP.jsp" class="submitphoto_form">
            <label>Blood Group Required</label>
            <input type="text" name="blood" class="wp-form-control wpcf7-text"><br>
              <label>Number of bottles</label>
                      <input type="text" name="num_bottle" class="wp-form-control wpcf7-text"><br>
                        <label>Address</label>
            <input type="text" name="address" class="wp-form-control wpcf7-text"><br>
               <label>Contact</label>
